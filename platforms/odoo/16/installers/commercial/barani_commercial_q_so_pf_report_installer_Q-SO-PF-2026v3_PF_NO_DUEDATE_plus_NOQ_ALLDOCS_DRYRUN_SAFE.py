# ============================================================================
# ACTION NAME : BARANI COMMERCIAL Q/SO/PF REPORT INSTALLER — Q-SO-PF-2026v3 (production)
#
...
#      (e.g. SO-EXAMPLE -> INV-EXAMPLE) so the reference is numeric for internet banking.
...
ACTION_NAME = 'BARANI COMMERCIAL Q/SO/PF REPORT INSTALLER — Q-SO-PF-2026v3 (production: PF drops Due-Date; numeric red-bar payment ref on all docs)'
...
RECEIVING_IBAN_DISPLAY = 'XX00 0000 0000 0000 0000 0000'
RECEIVING_IBAN_CANON = 'XX0000000000000000000000'
RECEIVING_BIC_CANON = 'YOURBICXXX'
  ...
  <t t-call="barani_commercial.external_layout_standard_titled" t-lang="doc.partner_id.lang or user.lang">
    ...
    <div class="page barani_commercial_doc">
      <div id="informations" class="row mt-3 barani_info_block">
        ...
        <div class="col-2 mb-2" t-if="o.payment_term_id" name="payment_terms">
      ...
      <div t-if="not is_html_empty(o.note)" name="comment"><span t-field="o.note"/></div>
      ...
      <t t-set="barani_payment_bank" t-value="o.company_id.partner_id.bank_ids.filtered(lambda b: (b.acc_number or '').replace(' ', '') == 'XX0000000000000000000000' and ((b.bank_id.bic or '').replace(' ', '') == 'YOURBICXXX'))[:1]"/>
