# ============================================================================
# ACTION NAME : BARANI VAT REPORT — RESTORE FROM CURRENT L21 FINAL RESTORE POINT SAFE
...
DEFAULT_BACKUP_TAG = 'l21_final_20260609'
...
ACTION_NAME = 'BARANI VAT REPORT — RESTORE FROM CURRENT L21 FINAL RESTORE POINT SAFE'
...
for chk in checks:
    ...
    if not chk[1]:
        marker_error = True
if marker_error:
    lines.append('ERROR: restore-point content does not look like the intended L21 final RI/DPI 2026+ baseline. Refusing.')
    raise UserError('\n'.join(lines)[:90000])
lines.append('')
